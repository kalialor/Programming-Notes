...
// node_modules/@react-three/fiber/dist/index-adfddf12.esm.js
...
__publicField(ErrorBoundary, "getDerivedStateFromError", () => ({
  error: true
}));
    ...
    if (isEvent) {
      ...
      if (Array.isArray(value)) {
        ...
        if (!isColor && targetProp.setScalar)
          ...
          targetProp.set(value);
        const supportsColorManagement = "ColorManagement" in three_module_exports;
        if (!supportsColorManagement && !rootState.linear && isColor)
          targetProp.convertSRGBToLinear();
      }
    } else {
      currentInstance[key] = value;
      if (!rootState.linear && currentInstance[key] instanceof Texture) {
...
function createRoot(canvas) {
  ...
  return {
    configure(props = {}) {
      ...
      if ("ColorManagement" in three_module_exports) {
        setDeep(three_module_exports, legacy, ["ColorManagement", "legacyMode"]);
      }
...
react-reconciler/cjs/react-reconciler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-3M67Z5HD.js.map
